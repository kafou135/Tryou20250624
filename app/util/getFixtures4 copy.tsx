//rt { AllFixtures, Fixture } from "@/types";
//rt moment from 'moment';
//
//t API_KEY = process.env.API_KEY as string;
//
//
//
//t leagues =    [
...
//
//
//c function fetchFixturesByLeague(
//year: number,
//league: number,
//yearr: number
//romise<Fixture[]> {        const currentTimeFormat = moment().format('YYYY-MM-DD');
//
...
//
//
//rt default async function getFixtures(): Promise<AllFixtures[]> {
//
//
//try {
