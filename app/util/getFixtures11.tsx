...
for (const { league, yearr } of leagues)  {const year= moment().year(); const nextWeek1 = moment().add(3, 'days').format('YYYY-MM-DD');        const lastWeek1 = moment().add(1, 'days').format('YYYY-MM-DD');
