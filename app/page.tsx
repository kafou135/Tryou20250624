...
const   filteredFixtures10_2 : AllFixtures[] = await getFixtures11_2();
  ...
  if (!filteredFixtures_2?.length&&!filteredFixtures1_2.length 
&&!filteredFixtures2_2.length 
&&!filteredFixtures3_2.length 
&&!filteredFixtures4_2.length 
&&!filteredFixtures5_2.length 
&&!filteredFixtures6_2.length 
&&!filteredFixtures7_2.length 
&&!filteredFixtures8_2.length 
&&!filteredFixtures9_2.length 
&&!filteredFixtures10_2.length) {
    return null;
  }
  ...
  return (
    <div>
      ...
      <RefreshButton/>
    <StandingsAndFixtures filteredFixtures_2={filteredFixtures_2} filteredFixtures1_2={filteredFixtures1_2} 
filteredFixtures2_2={filteredFixtures2_2} 
filteredFixtures3_2={filteredFixtures3_2} 
filteredFixtures4_2={filteredFixtures4_2} 
filteredFixtures5_2={filteredFixtures5_2} 
filteredFixtures6_2={filteredFixtures6_2} 
filteredFixtures7_2={filteredFixtures7_2} 
filteredFixtures8_2={filteredFixtures8_2}
filteredFixtures9_2={filteredFixtures9_2}
filteredFixtures10_2={filteredFixtures10_2}/>
